ActiveAdmin.register TermsOfUse do
  ...
  controller do
    def remove_pdf
      ...
      pdf_attachment = terms_of_use.pdf_content_attachment
      pdf_attachment.purge_later if pdf_attachment.present?
      redirect_to shefali007_terms_of_use_path(terms_of_use)
    end
  end
